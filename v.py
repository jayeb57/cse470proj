...
class V(tk.Tk):
    ...
    def _config_button_style(self):
        ...
        #number button style
        style.configure('N.TButton', background='grey', foreground='white')
        #operator button style
        style.configure('O.TButton', background="turquoise",foreground='black')
        #baki button
        style.configure('B.TButton', background ='red',foreground='black')
